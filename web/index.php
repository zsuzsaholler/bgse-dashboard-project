...
<p>In our project we exploit the information collected on users but instead of focusing on the users' needs we provide an artist-centered tool. For an artist the most essential element, besides his music, that defines and makes him successful is his audience. Our aim is to explore the relationship between the success of a musician and the distinct characteristics of their fans. We believe that the social connections and social activity of an artist's audience carries useful information on his current and future success. Also, an automatized analyzis of the sentiments embodied in the tags and labels given by the users might reveal interesting aspects of the attitude of the audience towards an artist.</p>

			<h2>The solution</h2>
				
			<p>Our dataset contains information on a subset of users in 2011; what artists they listen to, how they are connected to each other and tag information.  In order to predict success of an artist we define three main independent variables describing the social characteristics and behavious of the artist's audience. In particular, we measure the users' centrality in the social network and their activity and then we create artist level measures summarizing these characteristics of their audiance. We also measure the attitude of users towards the artist by performing sentiment analysis on the tags given to the artist. We then regress these variables on the overall number of listens to the artist, our dependent variable and our measure of success, to examine whether and to what extent these characteristics can define the success of a certain artist.</p>
